...
public class RecordAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.textMethod = (TextView) convertView
					.findViewById(R.id.tvMethod);
			holder.textOrderId = (TextView) convertView
		...
		holder.textOrderId.setText(infos.get(position).getTransactionId());
